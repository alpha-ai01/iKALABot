...
# ดึงค่า API Key (ต้องเช็คใน Render ว่าใส่ชื่อ Key ให้ตรงกัน)
...
# ตั้งค่า Webhook ให้ Telegram ส่งข้อความมาที่ URL นี้
...
if __name__ == "__main__":
    # ต้องตั้งค่า Webhook ครั้งแรกด้วยลิงก์ URL ของคุณ
    bot.remove_webhook()
